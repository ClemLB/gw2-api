...
/**
 * @see <a href="https://wiki.guildwars2.com/wiki/API:2/skills">Wiki</a>
 */
@Service
@RequiredArgsConstructor
public class SkillsService extends AbstractService {

	@Value("${application.rest.endpoints.skills}")
	...
	public List<Skill> get(List<Integer> ids) throws TooManyArgumentsException {
