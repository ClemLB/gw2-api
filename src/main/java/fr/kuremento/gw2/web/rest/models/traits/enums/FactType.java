...
public enum FactType {
	ATTRIBUTE_ADJUST("AttributeAdjust"), BUFF("Buff"), BUFF_ARRAY("BuffArray"), BUFF_CONVERSION("BuffConversion"), COMBO_FIELD("ComboField"), COMBO_FINISHER("ComboFinisher"), DAMAGE("Damage"), DISTANCE(
